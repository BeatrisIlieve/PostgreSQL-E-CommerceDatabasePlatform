...
#### THE WHOLE SCRIPT CAN BE EXECUTED AT ONCE, AND IT WILL PRODUCE THE SAME OUTCOME WITHOUT NEEDING TO EXECUTE IT IN MULTIPLE STEPS. IT CAN BE FOUND HERE -> [Source Code]([entire_script.sql](https://github.com/BeatrisIlieve/PostgreSQL-E-CommerceDatabasePlatform/tree/main/sql_files#:~:text=last%20week-,entire_script.sql,-(File))https://github.com/BeatrisIlieve/PostgreSQL-E-CommerceDatabasePlatform/tree/main/sql_files#:~:text=last%20week-,entire_script.sql,-(File))
